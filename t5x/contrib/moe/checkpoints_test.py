...
class CheckpointsTest(parameterized.TestCase):
  ...
  def call_host_checkpointer(self,
    ...
    checkpointer = checkpoints.D2SCheckpointer(
        train_state,
        partitioner,
        self.tmp_dir,
        ds_iter,
  ...
  def validate_restore(self,
    ...
    """Verifies that D2SCheckpointer correctly sparsifies dense checkpoint."""
  ...
  def save(self,
    ...
    """We do not validate saves, as D2SCheckpointer only overwrites restore."""
