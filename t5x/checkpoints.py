...
class NonAtomicCheckpointer(orbax.checkpoint.Checkpointer):
  ...
  def restore(self,
              ...
              *args,
              ...
              override_path: Optional[Union[str, epath.Path]] = None,
              **kwargs) -> Any:
    """See superclass documentation."""
...
class CheckpointManager(orbax.checkpoint.CheckpointManager):
  ...
  def restore(
    ...
    param_infos = self._parameter_infos(self._train_state_shape)  # state dict
    if fallback_state is not None:
